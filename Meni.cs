...
namespace Biletarnica
{
    class Meni
    {
        ...
        private void IspisiMeni()
        {
            ...
            /* Ispisujemo redom opisne tekstove svih opcija, i obelezavamo ih redom brojevima, pocevsi od 1 */
            ...
            /* Uvek dodajemo podrazumevanu opciju 'Nazad' i obelezavamo je brojem 0 */
            Console.WriteLine();
